...
async def open_paint() -> dict:
    """Open Microsoft Paint maximize it"""
    global paint_app
    try:
        ...
        return {
            "content": [
                TextContent(
                    type="text",
                    text="Paint opened successfully monitor and maximized"
                )
            ]
        }
...
@mcp.tool()
async def add_text_in_paint(input1: float) -> dict:
    """Display a float value in Microsoft Paint"""
    global paint_app
    try:
        if not paint_app:
            return {
        ...
        paint_window.click_input(coords=(840, 620))
        time.sleep(0.5)
        ...
        canvas.click_input(coords=(840, 620))
        time.sleep(0.5)
        ...
        return {
            "content": [
                TextContent(
                    type="text",
                    text=f"Text:'{text}' Result added to Paint successfully!!"
                )
            ]
        }
    except Exception as e:
